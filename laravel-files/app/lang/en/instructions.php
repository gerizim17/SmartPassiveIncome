...
return array(
	...
	*/
	...
	"goals" => "<p>This page takes the cashflow form the <strong>Rental History page</strong> for the current year.</p><p>It breaks it down for each individual property and adds it to the graph.</p>",
